...
const AESFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aes_free(ptr >>> 0));
/**
*/
export class AES {
...
const BSMFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_bsm_free(ptr >>> 0));
/**
*/
export class BSM {
...
const ChainParamsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chainparams_free(ptr >>> 0));
/**
*/
...
const CipherKeysFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cipherkeys_free(ptr >>> 0));
/**
*/
...
const ECDHFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ecdh_free(ptr >>> 0));
/**
*/
export class ECDH {
...
const ECDSAFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ecdsa_free(ptr >>> 0));
/**
*/
export class ECDSA {
...
const ECIESCiphertextFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_eciesciphertext_free(ptr >>> 0));
/**
*/
...
const ExtendedPrivateKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_extendedprivatekey_free(ptr >>> 0));
/**
*/
...
const ExtendedPublicKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_extendedpublickey_free(ptr >>> 0));
/**
*/
...
const InterpreterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_interpreter_free(ptr >>> 0));
/**
*/
...
const KDFFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kdf_free(ptr >>> 0));
/**
*/
export class KDF {
...
const P2PKHAddressFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_p2pkhaddress_free(ptr >>> 0));
/**
*/
...
const RecoveryInfoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_recoveryinfo_free(ptr >>> 0));
/**
*/
...
const SighashSignatureFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sighashsignature_free(ptr >>> 0));
/**
*/
...
const TxInFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_txin_free(ptr >>> 0));
/**
*/
export class TxIn {
...
const TxOutFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_txout_free(ptr >>> 0));
/**
*/
export class TxOut {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rxd_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
