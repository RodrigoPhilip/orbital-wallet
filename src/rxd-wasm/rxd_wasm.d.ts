...
* @returns {Uint8Array}
*/
  static encrypt(key: Uint8Array, iv: Uint8Array, message: Uint8Array, algo: AESAlgorithms): Uint8Array;
/**
* @param {Uint8Array} key
* @param {Uint8Array} iv
* @param {Uint8Array} message
...
* @returns {Uint8Array}
*/
  static decrypt(key: Uint8Array, iv: Uint8Array, message: Uint8Array, algo: AESAlgorithms): Uint8Array;
}
/**
*/
export class BSM {
...
* @returns {PrivateKey}
*/
  static private_key_from_signature_k(signature: Signature, public_key: PublicKey, ephemeral_key: PrivateKey, preimage: Uint8Array, hash_algo: SigningHash): PrivateKey;
/**
...
* @returns {Signature}
*/
  static sign_with_random_k(private_key: PrivateKey, preimage: Uint8Array, hash_algo: SigningHash, reverse_k: boolean): Signature;
/**
* @param {PrivateKey} private_key
* @param {Uint8Array} preimage
* @param {SigningHash} hash_algo
...
* @returns {Signature}
*/
  static sign_with_deterministic_k(private_key: PrivateKey, preimage: Uint8Array, hash_algo: SigningHash, reverse_k: boolean): Signature;
/**
* @param {PrivateKey} private_key
* @param {PrivateKey} ephemeral_key
* @param {Uint8Array} preimage
...
* @returns {Signature}
*/
  static sign_with_k(private_key: PrivateKey, ephemeral_key: PrivateKey, preimage: Uint8Array, hash_algo: SigningHash): Signature;
/**
* @param {Uint8Array} message
* @param {PublicKey} pub_key
* @param {Signature} signature
...
* @returns {boolean}
*/
  static verify_digest(message: Uint8Array, pub_key: PublicKey, signature: Signature, hash_algo: SigningHash): boolean;
}
/**
*/
export class ECIES {
...
* @returns {KDF}
*/
  static pbkdf2(password: Uint8Array, salt: Uint8Array | undefined, hash_algo: PBKDF2Hashes, rounds: number, output_length: number): KDF;
}
/**
*/
...
*/
  constructor(signature: Signature, sighash_type: SigHash, sighash_buffer: Uint8Array);
/**
* @returns {string}
*/
  to_hex(): string;
...
* @returns {PublicKey}
*/
  recover_public_key(message: Uint8Array, hash_algo: SigningHash): PublicKey;
/**
* @returns {string}
*/
  to_der_hex(): string;
...
* @returns {SighashSignature}
*/
  sign(priv_key: PrivateKey, sighash: SigHash, n_tx_in: number, unsigned_script: Script, value: bigint): SighashSignature;
/**
* @param {PrivateKey} priv_key
* @param {PrivateKey} ephemeral_key
* @param {SigHash} sighash
...
* @returns {SighashSignature}
*/
  sign_with_k(priv_key: PrivateKey, ephemeral_key: PrivateKey, sighash: SigHash, n_tx_in: number, unsigned_script: Script, value: bigint): SighashSignature;
/**
* @param {SigHash} sighash
* @param {number} n_tx_in
* @param {Script} unsigned_script
...
* @returns {Uint8Array}
*/
  sighash_preimage(sighash: SigHash, n_tx_in: number, unsigned_script: Script, value: bigint): Uint8Array;
/**
* @param {PublicKey} pub_key
* @param {SighashSignature} sig
* @returns {boolean}
